              ...
              <div class="panel panel-default">
                ...
                <div id="collapse<?php echo $inc ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading<?php echo $inc ?>">
                  <div class="panel-body">
                    ...
                    <button data-Anchor="js-jobsForm" class="Button Button-Rounded Button-BlueLight Button-Apply Font-Upper Font-LightBlue no-barba"><?php _e("Apply", "Page: Jobs"); ?></button>
                  </div>
                </div>
              </div>
            <?php
